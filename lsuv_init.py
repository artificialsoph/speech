...
from keras.layers import Dense, Conv2D, Convolution2D
...
def LSUVInit(model, batch, verbose=True, margin=0.1, max_iter=10):
    ...
    classes_to_consider = (Dense, Conv2D, Convolution2D)
    ...
    for layer in model.layers:
        ...
        iteration = 0
        if verbose:
            print("{} variance at iteration {}: {}".format(
                layer.name, iteration, variance))
